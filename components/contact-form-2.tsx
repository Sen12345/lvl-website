...
//     if (state.errors.fullname !== null) {
//       if (
//         state.errors.fullname === null &&
//         state.errors.fullname !== "Full name is required"
//       ) {
//         await toast.success("", { description: "Query sent successfully" });
//       } else {
//         await toast.error("", { description: "Query sent successfully" });
//       }
//     }
//     // });
//   };
...
//       <form onClick={onSubmit} action={formAction}>
